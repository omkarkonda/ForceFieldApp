    ...
    <Tab label="Port A" >
      ...
      <Row>
       ...
       <h5>{"+/-" + this.props.data.tolerance + "%"}</h5>
        ...
        <Col xs="4">
        <h4>Volume</h4>
        <h5>{this.props.data.volume_type}</h5>
        </Col>
        <div className="clearfix"></div>
        <div className="line"></div>
       ...
       <h5>{"+/-" + this.props.data.tolerance + "%"}<i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
        ...
        <Col xs="4">
        <h4>Volume</h4>
        <h5>{this.props.data.volume_type}<i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
        </Col>
       </div>
       ...
       <div className="clearfix"></div>
        ...
        <h5><span>Volume:</span> {this.props.data.volume_type} <i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
       </Col>
       </div>
       </Col>    
       </Row>
    ...
    <Tab label="Grangemouth">
      <div>
       ...
       <h5>{"+/- "+this.props.data.actual_tolerance_dischargeport+"%"} <i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
        ...
        <Col xs="4">
        <h4>Volume</h4>
        <h5>100 KBBL {this.props.data.volume_type} <i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
        </Col>
       </div>
