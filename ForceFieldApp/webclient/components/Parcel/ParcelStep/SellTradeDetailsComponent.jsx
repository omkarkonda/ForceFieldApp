...
export default class SellTradeDetailsComponent extends React.Component{
...
console.log(flow2Obj)
        this.props.saveDataFlow3(flow2Obj);
    }
        ...
        return(
            <div className="tradeDetailsWrapper" >                
                <div className="createParcel">
                    <h4>{this.props.sellTradePhase2.sell_deal}</h4> 
                    <div className="buyDetails">
                        <span>{this.props.sellTradePhase2.Discharge_Port}</span>
                    ...
                    <div className="parcelForm">
                        <form>
                            ...
                            <br />
                             <RaisedButton label="Save Data" secondary={true} onTouchTap={this.saveDataFlow3} />                     
                        </form>  
                    </div>
                </div>
            </div>
