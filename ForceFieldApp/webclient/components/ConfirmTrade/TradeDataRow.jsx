    ...
    return (
       <div>
        <TableRow onClick={this.openCollapse}>
            <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}  >{this.props.data.last_update_timestamp}      
             </TableRowColumn>
            ...
            <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}} > {this.props.data.party2} </TableRowColumn>
