...
export default class InspectorComponent extends React.Component {
  ...
  render() {
      return (
        ...
        <InspectorTableComponent headingText="New Request" handleChangeAgentSubmit={this.handleChangeAgentSubmit} number={this.state.countInspectorCount} data={this.state.inspectorData}/>
        </Col>
      </Row>
          </div>
      )
