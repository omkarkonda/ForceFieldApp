    ...
    return (
       <div style={{width:"auto"}}>
            ...
            <TableRow onTouchTap={this.openCollapse} style={{width:"100%"}} >
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}>{this.props.data.last_update_timestamp}</TableRowColumn>
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}>{this.props.data.trid} </TableRowColumn>
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}> {this.props.data.direction} </TableRowColumn>
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}> {Counterparty1} </TableRowColumn>
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}> {this.props.data.product_name} </TableRowColumn>
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}> {this.props.data.volume} </TableRowColumn>
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}> {this.props.data.trade_location} </TableRowColumn>
                <TableRowColumn style={{"width":"110px","vertical-align":"middle","padding":"5px"}}> {this.props.data.inco_term} </TableRowColumn>
            </TableRow>
...
<HistoryTableComponent historytradeData={this.state.historytradeData}/>
 ...
 <DatePicker name="lcFromDate"
  ...
  >
    ...
    <Col xs={8} >
    <Chip style={{width:"max-content",marginBottom:"11px",marginTop:"30px"}} >
 {this.props.data.direction} Trade
  ...
  >
    <MenuItem value="BBL" primaryText="KEBL" />
