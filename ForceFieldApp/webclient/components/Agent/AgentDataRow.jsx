...
//   import TradeSubChildComponent from './TradeSubChildComponent.jsx';
  class AgentDataRow extends React.Component{

    state={
        openRow:false,
        drid:this.props.data.drid,
        status:this.props.data.status,
        actualLaycanLoadedFrom:this.props.data.volume_type,
        actualLaycanLoadedTo:"",
        actualCargoLoadedFrom:this.props.data.quality_api,
        actualCargoLoadedTo:"",
        actualVesselLoadedFrom:this.props.data.quality_sul,
        actualVesselLoadedTo:"",
    ...
    handleChangeAgentSubmit=()=>{
		...
		actual_laycan_loadport:this.formatDate(this.state.actualLaycanLoadedFrom)+"-"+this.formatDate(this.state.actualLaycanLoadedTo),
		actual_cargo_loading:this.formatDate(this.state.actualCargoLoadedFrom)+"-"+this.formatDate(this.state.actualCargoLoadedTo),
        actual_vessel_move_loadport:this.formatDate(this.state.actualVesselLoadedFrom)+"-"+this.formatDate(this.state.actualVesselLoadedTo),
        ...
        <div className="parcelForm">
            <form>
                ...
                <div className="formControl">
                    ...
                    <DatePicker hintText="Start" style={{width:"150px"}}   textFieldStyle={{width:"145px"}} onChange={this.handleChangeLaycanLoadedFrom}  />
                                    <DatePicker hintText="End" style={{width:"100px"}} textFieldStyle={{width:"150px"}} onChange={this.handleChangeLaycanLoadedTo}/>
                    </div>
                </div>
                <div className="formControl">
                    ...
                    <DatePicker hintText="Start" style={{width:"150px"}}   textFieldStyle={{width:"145px"}} onChange={this.handleChangeCargoLoadedFrom}  />
                                    <DatePicker hintText="End" style={{width:"100px"}} textFieldStyle={{width:"150px"}} onChange={this.handleChangeCargoLoadedTo}/>
                    </div>
                </div>
                <div className="formControl">
                    ...
                    <DatePicker hintText="Start" style={{width:"150px"}}   textFieldStyle={{width:"145px"}} onChange={this.handleChangeVesselLoadedFrom}  />
                                    <DatePicker hintText="End" style={{width:"100px"}} textFieldStyle={{width:"150px"}} onChange={this.handleChangeVesselLoadedTo}/>
                    </div>
                </div>  
                <div className="formControl">
...
<TableRowColumn style={{width:'10%' , paddingTop: '15px'}}>{this.props.data.Organization1} </TableRowColumn>
       ...
       <Collapse in={this.state.openRow} style={{position:"relative", left:"0"}}>
                   ...
                   <div>
                       <div style={style.leftDetails}>
                        ...
                        <Col xs={12}>
                        <h4>Dates</h4>
        <h5><span style={style.agentDetails}>Laycan:</span>{this.props.data.laycan_loadport}</h5>
        <h5><span style={style.agentDetails}>Cargo Load:</span>{this.props.data.cargo_loading_date}</h5>
        <h5><span style={style.agentDetails}>Vessel Move:</span>{this.props.data.vessel_move_loadport}</h5>
       </Col>
       ...
       <div className="line">
        ...
        <h5><span style={style.agentDetails}>Laycan:</span> {this.props.data.actual_laycan_loadport}  <i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
        <h5><span style={style.agentDetails}>Cargo Load:</span>  {this.props.data.actual_cargo_loading_date}  <i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
        <h5><span style={style.agentDetails}>Vessel Move:</span>  {this.props.data.actual_vessel_move_loadport} <i className="fa fa-check-circle fa-3 icon" style={style.iconColor}  aria-hidden="true"></i></h5>
